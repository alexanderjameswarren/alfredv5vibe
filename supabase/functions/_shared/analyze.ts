...
export interface MeasureAnalysis extends MeasureFacts {
  seconds: number;
 ...
 */
export function measureAtTempo(facts: MeasureFacts, bpm: number): MeasureAnalysis {
 ...
 */
export function analyzeSongFacts(doc: SongDocument) {
